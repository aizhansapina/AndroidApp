...
public class com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy extends com.esoxjem.movieguide.favorites.MovieRealmObject
    implements RealmObjectProxy, com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface {
    ...
    private ProxyState<com.esoxjem.movieguide.favorites.MovieRealmObject> proxyState;

    com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.esoxjem.movieguide.favorites.MovieRealmObject>(this);
    ...
    @SuppressWarnings("cast")
    public static com.esoxjem.movieguide.favorites.MovieRealmObject createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.esoxjem.movieguide.favorites.MovieRealmObject obj = null;
        if (update) {
            Table table = realm.getTable(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
            MovieRealmObjectColumnInfo columnInfo = (MovieRealmObjectColumnInfo) realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy) realm.createObjectInternal(com.esoxjem.movieguide.favorites.MovieRealmObject.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy) realm.createObjectInternal(com.esoxjem.movieguide.favorites.MovieRealmObject.class, json.getString("id"), true, excludeFields);
                }
            } else {
        ...
        final com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface objProxy = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) obj;
    ...
    public static com.esoxjem.movieguide.favorites.MovieRealmObject createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.esoxjem.movieguide.favorites.MovieRealmObject obj = new com.esoxjem.movieguide.favorites.MovieRealmObject();
        final com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface objProxy = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.esoxjem.movieguide.favorites.MovieRealmObject copyOrUpdate(Realm realm, com.esoxjem.movieguide.favorites.MovieRealmObject object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.esoxjem.movieguide.favorites.MovieRealmObject) cachedRealmObject;
        }

        com.esoxjem.movieguide.favorites.MovieRealmObject realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
            MovieRealmObjectColumnInfo columnInfo = (MovieRealmObjectColumnInfo) realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
            long pkColumnIndex = columnInfo.idIndex;
            String value = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$id();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy();
    ...
    public static com.esoxjem.movieguide.favorites.MovieRealmObject copy(Realm realm, com.esoxjem.movieguide.favorites.MovieRealmObject newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.esoxjem.movieguide.favorites.MovieRealmObject realmObject = realm.createObjectInternal(com.esoxjem.movieguide.favorites.MovieRealmObject.class, ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) newObject).realmGet$id(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface realmObjectSource = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) newObject;
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface realmObjectCopy = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.esoxjem.movieguide.favorites.MovieRealmObject object, Map<RealmModel,Long> cache) {
        ...
        MovieRealmObjectColumnInfo columnInfo = (MovieRealmObjectColumnInfo) realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
        long pkColumnIndex = columnInfo.idIndex;
        String primaryKeyValue = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$id();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$overview = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$overview();
        if (realmGet$overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.overviewIndex, rowIndex, realmGet$overview, false);
        }
        String realmGet$releaseDate = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$releaseDate();
        ...
        String realmGet$posterPath = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$posterPath();
        ...
        String realmGet$backdropPath = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$backdropPath();
        ...
        String realmGet$title = ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$title();
        if (realmGet$title != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.titleIndex, rowIndex, realmGet$title, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.voteAverageIndex, rowIndex, ((com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) object).realmGet$voteAverage(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MovieRealmObjectColumnInfo columnInfo = (MovieRealmObjectColumnInfo) realm.getSchema().getColumnInfo(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.esoxjem.movieguide.favorites.MovieRealmObject object = null;
        while (objects.hasNext()) {
            object = (com.esoxjem.movieguide.favorites.MovieRealmObject) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.esoxjem.movieguide.favorites.MovieRealmObject object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.esoxjem.movieguide.favorites.MovieRealmObject.class);
    ...
    public static com.esoxjem.movieguide.favorites.MovieRealmObject createDetachedCopy(com.esoxjem.movieguide.favorites.MovieRealmObject realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.esoxjem.movieguide.favorites.MovieRealmObject unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.esoxjem.movieguide.favorites.MovieRealmObject();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.esoxjem.movieguide.favorites.MovieRealmObject) cachedObject.object;
            }
            unmanagedObject = (com.esoxjem.movieguide.favorites.MovieRealmObject) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface unmanagedCopy = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) unmanagedObject;
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface realmSource = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) realmObject;
    ...
    static com.esoxjem.movieguide.favorites.MovieRealmObject update(Realm realm, com.esoxjem.movieguide.favorites.MovieRealmObject realmObject, com.esoxjem.movieguide.favorites.MovieRealmObject newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface realmObjectTarget = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) realmObject;
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface realmObjectSource = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy aMovieRealmObject = (com_esoxjem_movieguide_favorites_MovieRealmObjectRealmProxy)o;
